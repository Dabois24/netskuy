...
public class GuardStateMachine : StateMachine
{
    ...
    [field: SerializeField] public float sentryMinAngle { get; private set; } = -45f;
    [field: SerializeField] public float sentryMaxAngle { get; private set; } = 45f;
    [field: SerializeField] public float sentryRotateSpeed { get; private set; } = 50f;
